      ...
      <div className="row d-flex justify-content-end">
        <div className="col-4 d-flex justify-content-between">
          ...
          >
            ...
            <option value="www.ravahna.com">www.ravahna.com</option>
          </select>
          <select className="tours-box p-2 medium-font rounded-top text-center"
                  name="country"
          ...
          <div>
            ...
            <div className="row mt-2 vh-17vh">
                  ...
                  <div className="col-6">
                    ...
                    <div className="upload-poster-div p-2 d-flex align-items-center">
                      <input  type="date" 
                              ...
                              value={activeIndex===index?formData.publishFrom:""}
                      ></input>
                  ...
                  <div className="col-6">
                    ...
                    <div className="upload-poster-div p-2 d-flex align-items-center">
                      <input  type="date"
                              className="file-input"
                              name="publishUpto"
                              value={activeIndex===index?formData.publishUpto:""}
                              onChange={(e)=>handleChange(e,index)}
                      ></input>
                      <FaCalendarDays className="ions-clr" />
                    </div>
              ...
              <div className="col">
                ...
                <div className="upload-poster-div p-2 d-flex align-items-center">
                  <textarea className="text-input-poster"
                            name="tourTitle"
                  ...
                  <div className="col-6">
                    ...
                    <div className="upload-poster-div p-2 d-flex align-items-center">
                      <input  type="date" 
                              className="file-input"
                              name="scheduleFrom"
                              value={activeIndex===index? formData.scheduleFrom:""}
                              onChange={(e)=>handleChange(e,index)}
                      ></input>
                      <FaCalendarDays className="ions-clr" />
                    </div>
                  ...
                  <div className="col-6">
                    ...
                    <div className="upload-poster-div p-2 d-flex align-items-center">
                      <input  type="date"
                              className="file-input"
                              name="scheduleUpto"
                              value={activeIndex===index?formData.scheduleUpto:""}
                              onChange={(e)=>handleChange(e,index)}
                      ></input>
                      <FaCalendarDays className="ions-clr" />
                    </div>
